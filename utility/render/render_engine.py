...
from moviepy.config import change_settings  # ✅ Import change_settings
import requests
...
def get_output_media(audio_file_path, timed_captions, background_video_data, video_server):
    ...
    magick_path = r"D:\ImageMagick-7.1.1-Q16\magick.exe"
    print("Using ImageMagick at:", magick_path)
